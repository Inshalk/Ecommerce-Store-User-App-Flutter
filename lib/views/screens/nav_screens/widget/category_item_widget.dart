...
import 'package:mac_store/views/screens/detail/screens/inner_category_screen.dart';
                  ...
                  physics: const NeverScrollableScrollPhysics(),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return InkWell(
                        ...
                        child: Column(
                          children: [
                            Image.network(category.image,width: 47,height: 47,),
                            Text(category.name,style: GoogleFonts.quicksand(fontWeight:FontWeight.bold,fontSize:16),),
                          ],
                        ),
                      );
                    })
