...
import 'package:mac_store/views/screens/detail/screens/product_detail_screen.dart';
...
class _ProductItemWidgetState extends ConsumerState<ProductItemWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final isFavorite = ref.watch(favoriteProvider.select((data) => data.containsKey(widget.product.id)));
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: InkWell(
                      ...
                      child:
                      Icon(Icons.add_shopping_cart_outlined, size: 26,),
