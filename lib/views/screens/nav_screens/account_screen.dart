...
import 'package:mac_store/provider/cart_provider.dart';
import 'package:mac_store/provider/delivered_order_count_provider.dart';
import 'package:mac_store/provider/favorite_provider.dart';
import 'package:mac_store/provider/user_provider.dart';
import 'package:mac_store/views/screens/detail/screens/order_screen.dart';
import 'package:mac_store/views/screens/detail/screens/shipping_address_screen.dart';
...
class _AccountScreenState extends ConsumerState<AccountScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    //Fecth the delivered order count
    ref
        .read(deliveredOrderCountProvider.notifier)
        .fetchDeliveredOrderCount(buyerId, context);
    //Watch the deliveredOrderCountProvider
    final deliverdCount = ref.watch(deliveredOrderCountProvider);
